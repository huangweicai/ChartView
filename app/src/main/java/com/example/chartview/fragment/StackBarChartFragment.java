...
import com.hwc.chart.StackBarChartView;
...
public class StackBarChartFragment extends Fragment {
    ...
    private List<BaseChartView.DataBean> getDayData() {
        ...
        datas1.add(new BaseChartView.DataBean("2017-09-25 00:17:00", 40f, 40f+30f, 40f+30f+20f, true));
        datas1.add(new BaseChartView.DataBean("2017-09-25 06:17:00", 50, 50+38, 50+38+20, true));
        datas1.add(new BaseChartView.DataBean("2017-09-25 12:17:00", 50, 50+38, 50+38+20, true));
        datas1.add(new BaseChartView.DataBean("2017-09-25 18:17:00", 50, 50+38, 50+38+20, false));
        datas1.add(new BaseChartView.DataBean("2017-09-25 24:17:00", 92f, 92f+78f, 92f+78f+50f, true));
        return datas1;
    }
