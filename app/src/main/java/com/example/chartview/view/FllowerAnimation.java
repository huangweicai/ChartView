...
import com.example.chartview.bean.Fllower;
...
public class FllowerAnimation extends View implements ValueAnimator.AnimatorUpdateListener {
    ...
    public FllowerAnimation(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void drawFllower(Canvas canvas, List<Fllower> fllowers) {
        for (Fllower fllower : fllowers) {
            ...
            Log.d("TAG", "height:"+height+"   getValue:"+fllower.getValue());//y一直为0
